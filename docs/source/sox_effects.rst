...
.. warning::
   ...
   `SoxEffect` and `SoxEffectsChain` are deprecated. Please migrate to :func:`apply_effects_tensor` and :func:`apply_effects_file`.
...
SoxEffect (deprecated)
----------------------

.. autofunction:: SoxEffect
